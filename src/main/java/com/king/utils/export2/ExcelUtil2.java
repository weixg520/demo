...
import com.king.utils.Convert;
import com.king.utils.StringUtils;
import com.king.utils.export2.annontation.Excel;
import com.king.utils.export2.annontation.Excels;
...
public class ExcelUtil2<T> {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (val instanceof String) {
                            val = com.king.utils.DateUtil.parseDate(val);
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StringUtils.isNotEmpty(dateFormat) && StringUtils.isNotNull(value)) {
                    cell.setCellValue(com.king.utils.DateUtil.parseDateToStr(dateFormat, (Date) value));
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = KingConfig.getDownloadPath() + filename;
