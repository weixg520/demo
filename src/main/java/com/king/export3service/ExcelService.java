package com.king.export3service;
...
public class ExcelService {
    ...
    public static void exportExcel(List<?> list, String title, String sheetName, Class<?> pojoClass, String fileName, HttpServletResponse response) {
        ...
        if (StringUtils.contains(fileName, ".xlsx")) {
            ...
            defaultExport(list, pojoClass, fileName, response,
                    new ExportParams(title, sheetName, ExcelType.HSSF));
        }
     ...
     * @param response
     */
    public static void exportTemplateExcel(Map<String, Object> map,
...
//            throw new BusinessException(e.getMessage(), false);
    ...
    public static <T> List<T> importExcel(MultipartFile file, Integer titleRows, Integer headerRows, Class<T> pojoClass) {
        ...
        List<T> list = null;
        try {
            list = ExcelImportUtil.importExcel(file.getInputStream(), StudentEntity.class, params);
        } catch (NoSuchElementException e) {
